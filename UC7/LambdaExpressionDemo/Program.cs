...
namespace LambdaExpressionDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            RemoveRecord(listPersonInCity);//uc7
            Console.ReadKey();
        }
        ...
        {
            listPersonsInCity.RemoveAll(e => (e.Name == "Winston"));
            if (listPersonsInCity.TrueForAll(e => e.Name != "Winston"))
                {
                Console.WriteLine("No person is found with 'Winston' name in current list");
            }
        }
